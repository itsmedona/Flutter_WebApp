...
import 'package:flutter_web_dashboard/models/bar_models/bar_graph_model.dart';
...
class BarGraphCard extends StatelessWidget {
  BarGraphCard({super.key, required this.mediaQueryData});
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: mediaQueryData.size.width >= kScreenWidthLg ? 2 : 1,
        //  Responsive.isMobile(context) ? 1 : 3,
        crossAxisSpacing: kDefaultPadding,
        // !Responsive.isMobile(context) ? 15 : 12,
        mainAxisSpacing: kDefaultPadding,
        childAspectRatio: 2,
        // Responsive.isMobile(context) ? 16 / 9 : 5 / 4
      ),
